...
def levenshtein_similarity(str1, str2):
    return 1 - jellyfish.levenshtein_distance(str1.lower(), str2.lower()) / max(
        len(str1), len(str2)
    )
...
def combined_correctness(
    ...
    return (
        levenshtein_sim >= threshold_levenshtein or jaccard_sim >= threshold_cosine
    ) and symmetric_sim >= symmetric_threshold
